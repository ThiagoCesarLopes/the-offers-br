defmodule TheoffersbrWeb.Router do
  ...
  pipeline :browser do
    ...
    plug :put_root_layout, html: {TheoffersbrWeb.Layouts, :root}
  ...
  # scope "/api", TheoffersbrWeb do
  #   pipe_through :api
  # end

  # Enable LiveDashboard and Swoosh mailbox preview in development
  if Application.compile_env(:theoffersbr, :dev_routes) do
    ...
    scope "/dev" do
      ...
      live_dashboard "/dashboard", metrics: TheoffersbrWeb.Telemetry
